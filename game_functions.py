...
def check_keydown_events(event, ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if event.type == pygame.KEYDOWN:
        if event.key == pygame.K_RIGHT:
            ...
            reset(ai_settings, screen, stats, sb, ship, aliens, bullets)

def reset(ai_settings, screen, stats, sb, ship, aliens, bullets):
...
def update_screen(screen,fond, stats, sb, ship, bullets, aliens, play_button):
    ...
    # Meke the most recently drawn screen visible.
    pygame.display.flip()
...
def update_bullets(ai_settings, screen, ship, stats, sb, aliens, bullets ):
    ...
    bullets.update()
    check_bullet_alien_collisoins(ai_settings, screen,stats, sb, ship, aliens, bullets)
...
def check_bullet_alien_collisoins(ai_settings, screen,stats, sb, ship, aliens, bullets):
...
def get_number_aliens_x(ai_settings, alien_width):
    """Determin the nubmer of aliens that fit in a row."""
...
def get_number_rows(ai_settings, ship_height, alien_height):
    ...
    nubmer_rowns = int(available_space_y / (2 * alien_height))
    return nubmer_rowns
...
def check_fleet_edge(ai_settings, aliens):
    """REspond appropriately i any aliens have reached an adge."""
...
def update_aliens(ai_settings, stats, sb, screen, ship, aliens, bullets):
    ...
    # Look or alien-ship collisions.
    if pygame.sprite.spritecollide(ship, aliens, False, False):
...
def ship_hit(ai_settings, stats, sb, screen, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        # Crete a enw fleet and center the ship.
        create_fleet(ai_settings, screen, ship, aliens)
        ship.center_ship()
...
def check_hight_score(stats, sb):
    """Chack to see if there's a new high score."""
